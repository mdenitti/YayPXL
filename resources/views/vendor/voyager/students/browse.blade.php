...
@section('content')
    <div class="page-content browse container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
            <h3>Course overzicht</h3>
            @php 
            $aCourse = [];
            $aCourseCount = [];
            $courses = App\Models\Course::with('student')->get();
            @endphp

            @foreach ($courses as $course)
                {{$course->course_name}}: <b>{{$course->student->count()}}</b><hr>
                @php
                    array_push($aCourse, $course->course_name);
                    array_push($aCourseCount, $course->student->count());
                @endphp
            @endforeach
            @php
            $aCourse = json_encode($aCourse);
            $aCourseCount = json_encode($aCourseCount);
            @endphp
